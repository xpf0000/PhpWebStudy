  ...
  <el-card class="version-manager">
    <template #header>
      <div class="card-header">
        <div class="left">
          <span> {{ title }} </span>
          <el-tooltip :content="$t('base.customVersionDirTips')" :show-after="600" placement="top">
            <el-button
          ...
          <template v-if="typeFlag === 'mysql' || typeFlag === 'mariadb'">
            <el-tooltip content="phpMyAdmin" :show-after="600" placement="top">
...
<script lang="ts" setup>
  ...
  import { reloadService, startService, stopService, waitTime, AsyncComponentShow } from '@web/fn'

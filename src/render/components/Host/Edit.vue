        ...
        <div class="main">
          ...
          <div class="path-choose mt-20 mb-20">
            <input type="text" :class="'input' + (errs['root'] ? ' error' : '')"
              :placeholder="$t('host.placeholderRootPath')" :value="item.root" />
        ...
        <div class="main">
          ...
          <template v-if="item.useSSL && !item.autoSSL">
            <div class="path-choose mt-20">
              <input type="text" :class="'input' + (errs['cert'] ? ' error' : '')" placeholder="cert"
                :value="item.ssl.cert" />
            ...
            <div class="path-choose mt-20 mb-20">
              <input type="text" :class="'input' + (errs['certkey'] ? ' error' : '')" placeholder="cert key"
                :value="item.ssl.key" />

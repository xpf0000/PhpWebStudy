export default {
  ...
  'update-available-message': 'Новая версия PhpWebStudy доступна для скачивания, скачать сейчас?',
  ...
  'hide': 'Спрятать PhpWebStudy',
  'hide-others': 'Спрятать все остальное',
  'unhide': 'Отобразить все',
  'show': 'Отобразить PhpWebStudy',
  'quit': 'Закрыть PhpWebStudy',

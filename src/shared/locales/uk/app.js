export default {
  ...
  'update-available-message': 'Нова версія PhpWebStudy доступна для завантаження, завантажити зараз?',
  ...
  'hide': 'Сховати PhpWebStudy',
  'hide-others': 'Сховати інше',
  'unhide': 'Відобразити все',
  'show': 'Відобразити PhpWebStudy',
  'quit': 'Закрити PhpWebStudy',
